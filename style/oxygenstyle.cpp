...
namespace Oxygen
{
    ...
    QRect Style::scrollBarSubControlRect( const QStyleOptionComplex* option, SubControl subControl, const QWidget* widget ) const
    {
        ...
        switch ( subControl )
        {
            ...
            case SC_ScrollBarGroove:
            {
                ...
                QRect bottom = handleRTL( option, scrollBarInternalSubControlRect( option, SC_ScrollBarAddLine ) );
                ...
                if( horizontal )
                {
                    ...
                    bottomRightCorner = QPoint( bottom.left()  - 1, top.bottom() );

                } else {

                    topLeftCorner  = QPoint( top.left(),  top.bottom() + 1 );
                    bottomRightCorner = QPoint( top.right(), bottom.top() - 1 );

                }

                // define rect
                return handleRTL( option, QRect( topLeftCorner, bottomRightCorner )  );
    ...
    bool Style::drawScrollBarSliderControl( const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        if( horizontal )
        {
            ...
            renderScrollBarHole( painter, holeRect, argbHelper().translucentColor( palette.color(QPalette::Window), hasAlpha ), Qt::Horizontal, tiles );
            ...
            // render
            renderScrollBarHole( painter, holeRect, argbHelper().translucentColor( palette.color(QPalette::Window), hasAlpha ), Qt::Vertical, tiles );
