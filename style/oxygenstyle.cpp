...
//         #endif
    ...
    bool Style::eventFilterComboBoxContainer( QWidget* widget, QEvent* event )
    {
        switch( event->type() )
        {
            ...
            case QEvent::Paint:
            {
                ...
                // background
                _helper.renderMenuBackground( &painter, paintEvent->rect(), widget, argbHelper().translucentColor( color, hasAlpha ) );
        ...
        switch( event->type() )
        {
            ...
            case QEvent::Paint:
            {
                ...
                if( dockWidget->isWindow() )
                {
                    ...
                    _helper.renderWindowBackground( &painter, r, dockWidget, argbHelper().translucentColor( color, hasAlpha ) );
    ...
    bool Style::eventFilterToolBar( QToolBar* toolBar, QEvent* event )
    {
        switch( event->type() )
        {
            ...
            case QEvent::Paint:
            {
                ...
                // background
                _helper.renderWindowBackground( &painter, r, toolBar, argbHelper().translucentColor( color, hasAlpha ) );
    ...
    bool Style::drawPanelMenuPrimitive( const QStyleOption* option, QPainter* painter, const QWidget* widget ) const
    {
        ...
        _helper.renderMenuBackground( painter, r, widget, argbHelper().translucentColor( color, hasAlpha ) );
